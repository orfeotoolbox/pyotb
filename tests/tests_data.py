...
SIMPLE_SERIALIZATION = {
    ...
    'parameters': {'in': {'name': 'OrthoRectification',
        'parameters': {'io.in': {'name': 'BandMath',
            ...
            'exp': 'im1b1', 'ram': 256}},
        'map.utm.zone': 31, 'map.utm.northhem': True, 'map.epsg.code': 4326, 'outputs.isotropic': True, 'outputs.default': 0.0,
...
COMPLEX_SERIALIZATION = {
    ...
    'parameters': {'il': [{'name': 'OrthoRectification',
        'parameters': {'io.in': {'name': 'BandMath',
            'parameters': {
                ...
                'exp': 'im1b1', 'ram': 256}},
        'map.utm.zone': 31, 'map.utm.northhem': True, 'map.epsg.code': 4326, 'outputs.isotropic': True, 'outputs.default': 0.0, 'elev.default': 0.0,
    ...
    {'name': 'ManageNoData',
        ...
        'parameters': {'io.in': {'name': 'BandMath',
            'parameters': {'il': ['/vsicurl/https://gitlab.orfeo-toolbox.org/orfeotoolbox/otb/-/raw/develop/Data/Input/SP67_FR_subset_1.tif'],
            'exp': 'im1b1', 'ram': 256}},
        'map.utm.zone': 31, 'map.utm.northhem': True, 'map.epsg.code': 4326, 'outputs.isotropic': True, 'outputs.default': 0.0, 'elev.default': 0.0, 'interpolator.bco.radius': 2,
